	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="movieQueryForm" id="movieQueryForm" action="<%=basePath %>Movie/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="releaseDate" name="releaseDate" class="form-control"  placeholder="请选择发行日期" value="<%=releaseDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="movie_releaseDate_edit" class="col-md-3 text-right">发行日期:</label>
		  	 <div class="col-md-9">
                <div class="input-group date movie_releaseDate_edit col-md-12" data-link-field="movie_releaseDate_edit" data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="movie_releaseDate_edit" name="movie.releaseDate" size="16" type="text" value="" placeholder="请选择发行日期" readonly>
