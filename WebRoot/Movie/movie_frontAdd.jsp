	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="movie_releaseDateDiv" class="col-md-2 text-right">发行日期frontAdd_1:</label>
				  	 <div class="col-md-8">
		                <div id="movie_releaseDateDiv" class="input-group date movie_releaseDate col-md-12" data-link-field="movie_releaseDate" data-link-format="yyyy-mm-dd">
		                    <input class="form-control" id="movie_releaseDate" name="movie.releaseDate" size="16" type="text" value="" placeholder="请选择发行日期frontAdd_2" readonly>
