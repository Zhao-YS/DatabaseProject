...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 <label for="movie_releaseDate_edit" class="col-md-3 text-right">发行日期frontmodify_2:</label>
		  	 <div class="col-md-9">
                <div class="input-group date movie_releaseDate_edit col-md-12" data-link-field="movie_releaseDate_edit" data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="movie_releaseDate_edit" name="movie.releaseDate" size="16" type="text" value="" placeholder="请选择发行日期frontmodify_1" readonly>
