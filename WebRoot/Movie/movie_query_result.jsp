...
<div id="movie_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="movieQueryForm" method="post">
			...
			发行日期query_result_2：<input type="text" id="releaseDate" name="releaseDate" class="easyui-datebox" editable="false" style="width:100px">
...
<div id="movieEditDiv">
	<form id="movieEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">发行日期query_result_1:</span>
			<span class="inputControl">
